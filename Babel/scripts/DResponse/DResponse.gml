function DResponse(argument0) {
	...
	// all the text responses in game must seperate these if it becomes an issue obviously can either be seperated
	// on entity by entity basis or area by area basis 


	switch(argument0)
	{
		case 0: break; 
		case 1: NewText(">:(",1);break ;
		...
		case 6: if global.playercoin >= 15{ global.playercoin--global.playercoin--global.playercoin--global.playercoin--global.playercoin--global.playercoin--global.playercoin--global.playercoin--global.playercoin--global.playercoin--global.PlayerKey++global.ocase1-- NewText("enjoy") }
		else {NewText("Come back when you have enough gold")} break;
